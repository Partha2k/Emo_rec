...
from keras.layers import Conv2D, AveragePooling2D, MaxPooling2D, Flatten, Dense, Dropout, BatchNormalization, Activation
...
plot_model(model, to_file='SimpleCNN.png')

history = model.fit(x_train, y_train, batch_size=32, epochs=n_iter, validation_split = 0.2)
